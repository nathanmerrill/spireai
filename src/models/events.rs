...
fn all_events() -> Vec<BaseEvent> {
    vec![
        BaseEvent {
            ...
            shrine: false,
            condition: Condition::Always,
            variants: vec![NEOW_FIRST_RUN, NEOW_SUCCESS_RUN],
            choices: vec![
                BaseEventChoice {
                    name: "Talk",
                    effects: vec![Effect::ShowChoices(vec![
                        NEOW_ONE_HP,
                        NEOW_SIX_HP,
                        NEOW_SEVEN_HP,
                        NEOW_EIGHT_HP,
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Elegance",
                    effects: vec![Effect::RemoveCard(1), Effect::ShowChoices(vec![LEAVE])],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
                    name: "Simplicity",
        ...
        BaseEvent {
            ...
            choices: vec![
                ...
                BaseEventChoice {
                    ...
                    effects: vec![Effect::TransformCard(2), Effect::ShowChoices(vec![LEAVE])],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
            ...
            choices: vec![
                ...
                BaseEventChoice {
                    ...
                    effects: vec![
                        ...
                        Effect::ShowReward(vec![RewardType::RandomRelic]),
                        Effect::ShowChoices(vec![LEAVE]),
                    ],
                    ..BaseEventChoice::new()
                },
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Offer",
                    effects: vec![Effect::Custom, Effect::ShowChoices(vec![LEAVE])],
                    ..BaseEventChoice::new()
                },
                leave(false),
            ],
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    ...
                    effects: vec![
                        Effect::Fight(
                            vec![monsters::BLUE_SLAVER, monsters::RED_SLAVER],
                            RoomType::HallwayFight,
                        ),
                        Effect::ShowChoices(vec![THE_COLOSSEUM_COWARDACE, THE_COLOSSEUM_VICTORY]),
                    ],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
                ...
                BaseEventChoice {
                    ...
                    effects: vec![
                        Effect::Fight(
                            vec![monsters::TASKMASTER, monsters::GREMLIN_NOB],
                            RoomType::Elite,
                        ),
            ...
            choices: vec![
                BaseEventChoice {
                    ...
                    effects: vec![
                        ...
                        Effect::Repeat(Amount::ByAsc(5, 3, 3), Box::new(
                            Effect::CreateCard {
                                name: cards::APPARITION,
                                location: CardLocation::DeckPile,
                                position: RelativePosition::Bottom,
                                then: vec![],
                            },
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Read",
                    effects: vec![Effect::ShowChoices(vec![CURSED_TOME_CONTINUE])],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
                    ...
                    effects: vec![
                        ...
                        Effect::If(
                            Condition::Equals(Amount::N, Amount::Fixed(3)),
                            vec![Effect::ShowChoices(vec![CURSED_TOME_CONTINUE])],
                            vec![Effect::ShowChoices(vec![
                                CURSED_TOME_TAKE,
                                CURSED_TOME_STOP,
                            ])],
                        ),
                ...
                BaseEventChoice {
                    ...
                    effects: vec![Effect::LoseHp(Amount::Fixed(3), Target::_Self)],
                    initial: false,
                    ..BaseEventChoice::new()
                },
                leave(true),
            ...
            choices: vec![
                BaseEventChoice {
                    ...
                    effects: vec![
                        ...
                        Effect::If(
                            Condition::Equals(Amount::X, Amount::Fixed(0)),
                            vec![
                                Effect::SetX(Amount::ByAsc(26, 42, 42)), // 25%, 35%
                            ],
                            vec![Effect::If(
                                Condition::LessThan(Amount::X, Amount::Fixed(60)),
                                vec![
                        ...
                        Effect::RandomChance(vec![
                            (
                                ...
                                Effect::Multiple(vec![
                                    Effect::If(
                                        Condition::IsVariant(DEAD_ADVENTURER_GREMLIN_NOB),
                                        vec![Effect::Fight(
                                            vec![monsters::GREMLIN_NOB],
                                            RoomType::Elite,
                                        )],
                                        vec![Effect::If(
                                            Condition::IsVariant(DEAD_ADVENTURER_LAGAVULIN),
                                            vec![Effect::Fight(
                                                vec![monsters::LAGAVULIN],
                                                RoomType::Elite,
                                            )],
                                            vec![Effect::Fight(
                                                vec![
                                    ...
                                    Effect::If(
                                        Condition::LessThan(Amount::N, Amount::Fixed(2)),
                                        vec![Effect::ShowReward(vec![
                                            RewardType::RandomRelic,
                                            RewardType::Gold(55, 65),
                                            RewardType::EliteCard,
                                        ])],
                                        vec![Effect::If(
                                            Condition::LessThan(Amount::N, Amount::Fixed(4)),
                                            vec![Effect::ShowReward(vec![
                                                RewardType::RandomRelic,
                                                RewardType::EliteCard,
                                            ])],
                                            vec![Effect::If(
                                                Condition::LessThan(Amount::N, Amount::Fixed(6)),
                                                vec![Effect::ShowReward(vec![
                                                    RewardType::Gold(55, 65),
                                                    RewardType::EliteCard,
                                                ])],
                            ...
                            (
                                ...
                                Effect::Multiple(vec![
                                    Effect::If(
                                        Condition::Equals(Amount::N, Amount::Fixed(0)),
                                        vec![Effect::RandomChance(vec![
                                        ...
                                        vec![Effect::If(
                                            Condition::Equals(Amount::N, Amount::Fixed(1)),
                                            vec![Effect::RandomChance(vec![
                                                (
                                                    Amount::Fixed(33),
                                                    Effect::Multiple(vec![
                                            ...
                                            vec![Effect::If(
                                                Condition::Equals(Amount::N, Amount::Fixed(2)),
                                                vec![Effect::RandomChance(vec![
                                                    (
                                                        Amount::Fixed(33),
                                                        Effect::AddN(Amount::Fixed(1)),
                                                ...
                                                vec![Effect::If(
                                                    ...
                                                    vec![Effect::If(
                                                        ...
                                                        vec![Effect::If(
                                                            ...
                                                            vec![Effect::AddN(Amount::Fixed(1))],
                                                        )],
                                                    )],
                                                )],
                                            )],
                                    ...
                                    Effect::If(
                                        Condition::Equals(Amount::N, Amount::Fixed(7)),
                                        vec![],
                                        vec![Effect::ShowChoices(vec![
                                            LEAVE,
        ...
        BaseEvent {
            ...
            choices: vec![
                ...
                BaseEventChoice {
                    ...
                    effects: vec![
                        ...
                        Effect::If(
                            ...
                            vec![Effect::RemoveCard(1)],
                            vec![Effect::TransformRandomCard(2)],
                        ),
                    ],
                    condition: Condition::MultipleAnd(vec![
                ...
                BaseEventChoice {
                    name: "Punch",
                    effects: vec![Effect::LoseHp(Amount::ByAsc(3, 5, 5), Target::_Self)],
                    ..BaseEventChoice::new()
                },
            ],
        },
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Pray",
                    effects: vec![Effect::DuplicateCard],
                    ..BaseEventChoice::new()
                },
                leave(true),
            ],
            ...
            choices: vec![
                BaseEventChoice {
                    ...
                    effects: vec![
                        ...
                        Effect::If(
                            Condition::Asc(15),
                            vec![Effect::AddGold(Amount::Fixed(50))],
                            vec![Effect::AddGold(Amount::Fixed(75))],
                        ),
                    ],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
                    name: "Trade",
                    effects: vec![Effect::RandomChance(vec![
                        (
                            Amount::Fixed(20),
                            Effect::AddRelic(relics::CULTIST_HEADPIECE),
                        ),
                        (Amount::Fixed(20), Effect::AddRelic(relics::FACE_OF_CLERIC)),
                        (Amount::Fixed(20), Effect::AddRelic(relics::GREMLIN_VISAGE)),
                        (
                            Amount::Fixed(20),
                            Effect::AddRelic(relics::NLOTHS_HUNGRY_FACE),
                        ),
            ...
            choices: vec![
                ...
                BaseEventChoice {
                    ...
                    condition: Condition::MultipleAnd(vec![
                        ...
                        Condition::Not(Box::new(Condition::HasRemoveableCards(
                            1,
                            CardType::Attack,
                        ))),
        ...
        BaseEvent {
            ...
            choices: vec![
                ...
                BaseEventChoice {
                    ...
                    effects: vec![Effect::DamagePercentage(Amount::ByAsc(25, 35, 35))],
                    initial: false,
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
                    name: GOLDEN_IDOL_HIDE,
                    effects: vec![Effect::ReduceMaxHpPercentage(Amount::ByAsc(8, 10, 10))],
                    initial: false,
                    ..BaseEventChoice::new()
                },
                leave(true),
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Pray",
                    effects: vec![Effect::AddGold(Amount::ByAsc(100, 50, 50))],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
                    name: "Desecrate",
            ...
            choices: vec![
                ...
                BaseEventChoice {
                    ...
                    effects: vec![
                        ...
                        Effect::RandomChance(vec![(
                            Amount::Fixed(30),
                            Effect::AddGold(Amount::Fixed(250)),
                        )]),
                    ],
                    ..BaseEventChoice::new()
                },
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    ...
                    effects: vec![
                        Effect::LoseHp(
                            Amount::Sum(vec![Amount::Fixed(6), Amount::Custom]),
                            Target::_Self,
                        ),
                ...
                BaseEventChoice {
                    ...
                    effects: vec![Effect::LoseHp(Amount::Fixed(6), Target::_Self)],
                    ..BaseEventChoice::new()
                },
            ],
        },
        ...
        BaseEvent {
            ...
            choices: vec![
                ...
                BaseEventChoice {
                    name: "Sleep",
                    effects: vec![Effect::HealPercentage(
                        Amount::ByAsc(33, 20, 20),
                        Target::_Self,
                    )],
                    ..BaseEventChoice::new()
                },
        ...
        BaseEvent {
            ...
            choices: vec![
                ...
                BaseEventChoice {
                    name: "Change",
                    effects: vec![Effect::TransformCard(1), Effect::ShowChoices(vec![LEAVE])],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
                    name: "Grow",
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Pay",
                    effects: vec![Effect::LoseAllGold],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
                    name: "Fight",
                    effects: vec![
                        Effect::Fight(
                            vec![monsters::POINTY, monsters::ROMEO, monsters::BEAR],
                            RoomType::HallwayFight,
                        ),
                        Effect::ShowReward(vec![
                ...
                BaseEventChoice {
                    ...
                    effects: vec![
                        Effect::RandomChance(vec![
                            (
                                Amount::Fixed(33),
                                Effect::Fight(vec![monsters::SLIME_BOSS], RoomType::Boss),
                            ),
                            (
                                Amount::Fixed(33),
                                Effect::Fight(vec![monsters::THE_GUARDIAN], RoomType::Boss),
                            ),
                            (
                                Amount::Fixed(33),
                                Effect::Fight(vec![monsters::HEXAGHOST], RoomType::Boss),
                            ),
                        ]),
                        Effect::If(
                            Condition::Asc(15),
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    ...
                    effects: vec![
                        Effect::Fight(
                            vec![monsters::ORB_WALKER, monsters::ORB_WALKER],
                            RoomType::HallwayFight,
                        ),
                        Effect::ShowReward(vec![
                            RewardType::Relic(Rarity::Rare),
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Smash and Grab",
                    effects: vec![Effect::AddGold(Amount::ByAsc(99, 50, 50))],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
                    name: "Stay in Line",
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Continue",
                    effects: vec![Effect::ShowChoices(vec![
                        A_NOTE_FOR_YOURSELF_TAKE,
                        A_NOTE_FOR_YOURSELF_IGNORE,
                    ])],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Offer Relic",
                    effects: vec![Effect::Custom, Effect::AddRelic(relics::NLOTHS_GIFT)],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
                    name: "Offer Relic",
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Offer Gold",
                    effects: vec![Effect::AddGold(Amount::Fixed(-75)), Effect::RemoveCard(1)],
                    condition: Condition::MultipleAnd(vec![
                        Condition::HasRemoveableCards(1, CardType::All),
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Offer Gold",
                    effects: vec![Effect::AddGold(Amount::Fixed(-85)), Effect::RandomRelic],
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Pray",
                    effects: vec![Effect::RemoveCard(1)],
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    ...
                    effects: vec![
                        Effect::LoseHp(
                            Amount::Sum(vec![Amount::ByAsc(3, 5, 5), Amount::N]),
                            Target::_Self,
                        ),
                        Effect::RandomChance(vec![
                            (
                                Amount::Sum(vec![Amount::Fixed(25), Amount::X]),
                                Effect::RandomRelic,
                            ),
                            (
                                Amount::Sum(vec![Amount::Fixed(75), Amount::NegX]),
                                Effect::Multiple(vec![
                                    Effect::AddN(Amount::Fixed(1)),
                                    Effect::AddX(Amount::Fixed(10)),
                                    Effect::If(
                                        Condition::Equals(Amount::X, Amount::Fixed(80)),
                                        vec![Effect::SetX(Amount::Fixed(75))],
                                        vec![],
                                    ),
                                    Effect::ShowChoices(vec![SCRAP_OOZE_REACH_INSIDE, LEAVE]),
                                ]),
                            ),
                        ]),
                    ],
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Recall (1 card)",
                    effects: vec![Effect::ShowReward(vec![RewardType::ColorlessCard])],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
                    name: "Recall (2 card)",
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Pray",
                    effects: vec![Effect::TransformCard(1)],
                    condition: Condition::HasRemoveableCards(1, CardType::All),
                    ..BaseEventChoice::new()
                },
                leave(true),
            ...
            choices: vec![
                BaseEventChoice {
                    ...
                    effects: vec![
                        ...
                        Effect::Custom,
                        Effect::Repeat(Amount::Fixed(5), Box::new(
                            Effect::CreateCard {
                                name: cards::BITE,
                                location: CardLocation::DeckPile,
                                position: RelativePosition::Bottom,
        ...
        BaseEvent {
            ...
            choices: vec![
                BaseEventChoice {
                    name: "Give Potion",
                    effects: vec![Effect::Custom, Effect::RandomRelic],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
                    name: "Give Gold",
                    effects: vec![Effect::AddGold(Amount::Custom), Effect::RandomRelic],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
                    name: "Give Card",
            ...
            choices: vec![BaseEventChoice {
                ...
                effects: vec![Effect::RandomChance(vec![
                    (
                        ...
                        Effect::If(
                            Condition::Act(1),
                            vec![Effect::AddGold(Amount::Fixed(100))],
                            vec![Effect::If(
                                Condition::Act(2),
                                vec![Effect::AddGold(Amount::Fixed(200))],
                                vec![Effect::AddGold(Amount::Fixed(300))],
                            )],
                        ),
                    ),
                    ...
                    (
                        Amount::Fixed(1),
                        Effect::DamagePercentage(Amount::ByAsc(10, 15, 15)),
                    ),
                ])],
                ..BaseEventChoice::new()
            }],
        ...
        BaseEvent {
            ...
            choices: vec![
                ...
                BaseEventChoice {
                    ...
                    effects: vec![Effect::ReduceMaxHpPercentage(Amount::Fixed(5))],
                    ..BaseEventChoice::new()
                },
            ],
        },
        BaseEvent {
            ...
            choices: vec![
                ...
                BaseEventChoice {
                    name: "Destroy",
                    effects: vec![Effect::AddGold(Amount::Custom)],
                    condition: Condition::Custom,
                    ..BaseEventChoice::new()
                },
                leave(true),
            ...
            choices: vec![
                BaseEventChoice {
                    ...
                    effects: vec![
                        ...
                        Effect::ShowReward(vec![RewardType::RandomPotion]),
                    ],
                    ..BaseEventChoice::new()
                },
                BaseEventChoice {
                ...
                BaseEventChoice {
                    ...
                    effects: vec![Effect::If(
                        Condition::Asc(15),
                        vec![Effect::ReduceMaxHpPercentage(Amount::Fixed(5))],
                        vec![],
                    )],
                    ..BaseEventChoice::new()
                },
