...
lazy_static! {
    static ref MONSTERS: HashMap<&'static str, BaseMonster> = {
        let mut m = HashMap::new();

        for monster in all_monsters() {
            m.insert(monster.name, monster);
        }
...
fn all_monsters() -> Vec<BaseMonster> {
    vec![
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::SPLIT, Fixed(1), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: CORROSIVE_SPIT,
                ...
                MonsterMove {
                    name: LICK,
                    effects: vec![Effect::AddBuff(buffs::WEAK, Fixed(2), Target::TargetEnemy)],
                ...
                MonsterMove {
                    name: SPLIT,
                    effects: vec![Effect::Split(ACID_SLIME_M, ACID_SLIME_M)],
            ...
            move_order: vec![
                Move::If(
                    Condition::Asc(17),
                    vec![Move::Loop(vec![Move::Probability(vec![
                        (40, CORROSIVE_SPIT, 2),
                        (30, TACKLE, 2),
                        (30, LICK, 1),
                    ])])],
        ...
        BaseMonster {
            ...
            moveset: vec![
                ...
                MonsterMove {
                    name: LICK,
                    effects: vec![Effect::AddBuff(buffs::WEAK, Fixed(1), Target::TargetEnemy)],
                    intent: Intent::Debuff,
                },
                MonsterMove {
                    name: TACKLE,
        ...
        BaseMonster {
            ...
            move_order: vec![
                Move::If(Condition::Asc(17), vec![Move::InOrder(LICK)], vec![]),
                Move::Loop(vec![Move::Probability(vec![
                    (50, LICK, 1),
                    (50, TACKLE, 1),
                ])]),
            ],
        ...
        BaseMonster {
            ...
            effects: vec![
                (
                    Event::CombatStart,
                    Effect::AddBuff(buffs::CURIOSITY, ByAsc(1, 1, 2), Target::_Self),
                ),
                (
                    Event::CombatStart,
                    Effect::AddBuff(buffs::STRENGTH, ByAsc(0, 2, 2), Target::_Self),
                ),
                (
                    Event::CombatStart,
                    Effect::AddBuff(buffs::REGENERATE, ByAsc(10, 10, 15), Target::_Self),
                ),
            ],
            moveset: vec![
                MonsterMove {
                    name: SLASH,
                    effects: vec![Effect::AttackDamage(Fixed(20), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
                MonsterMove {
                    name: SOUL_STRIKE,
                ...
                MonsterMove {
                    name: DARK_ECHO,
                    effects: vec![Effect::AttackDamage(Fixed(40), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
                MonsterMove {
                    name: SLUDGE,
        ...
        BaseMonster {
            ...
            moveset: vec![
                ...
                MonsterMove {
                    name: MAUL,
                    effects: vec![Effect::AttackDamage(ByAsc(18, 20, 20), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
            ],
            move_order: vec![
                Move::InOrder(BEAR_HUG),
                Move::Loop(vec![Move::InOrder(LUNGE), Move::InOrder(MAUL)]),
            ],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::PAINFUL_STABS, Fixed(1), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: MULTI_STAB,
            ...
            move_order: vec![Move::Loop(vec![Move::Probability(vec![
                (85, MULTI_STAB, 2),
                (15, MULTI_STAB, 1),
            ])])],
            ..BaseMonster::default()
        ...
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::ARTIFACT, Fixed(3), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: SPAWN_ORBS,
                ...
                MonsterMove {
                    name: HYPERBEAM,
                    effects: vec![Effect::AttackDamage(ByAsc(45, 50, 50), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
                MonsterMove {
                    name: STUNNED,
            ...
            move_order: vec![
                ...
                Move::Loop(vec![
                    ...
                    Move::If(
                        Condition::Asc(19),
                        vec![Move::InOrder(BOOST)],
                        vec![Move::InOrder(STUNNED)],
                    ),
                ]),
            ],
            ..BaseMonster::default()
        ...
        BaseMonster {
            ...
            moveset: vec![
                ...
                MonsterMove {
                    name: BEAM,
                    effects: vec![Effect::AttackDamage(Fixed(8), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
                MonsterMove {
                    name: SUPPORT_BEAM,
                    effects: vec![Effect::Block(Fixed(12), Target::Friendly(BRONZE_AUTOMATON))],
        ...
        BaseMonster {
            ...
            moveset: vec![
                MonsterMove {
                    name: CAW,
                    effects: vec![Effect::AddBuff(buffs::STRENGTH, Fixed(1), Target::_Self)],
                    intent: Intent::Buff,
                },
                MonsterMove {
                    name: PECK,
                    effects: vec![
                        ...
                        Effect::If(
                            Condition::Asc(2),
                            vec![Effect::AttackDamage(Fixed(1), Target::TargetEnemy)],
                            vec![],
                        ),
                    ],
                    intent: Intent::Attack,
                ...
                MonsterMove {
                    name: SWOOP,
                    effects: vec![Effect::AttackDamage(ByAsc(12, 14, 14), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
                MonsterMove {
                    name: FLY,
                ...
                MonsterMove {
                    name: HEADBUTT,
                    effects: vec![Effect::AttackDamage(Fixed(3), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
            ],
            move_order: vec![
                Move::Probability(vec![(125, PECK, 1), (75, CAW, 1)]),
                Move::Loop(vec![
                    Move::Loop(vec![Move::Probability(vec![
                        (50, PECK, 2),
                        (20, SWOOP, 1),
        ...
        BaseMonster {
            ...
            moveset: vec![
                ...
                MonsterMove {
                    ...
                    effects: vec![
                        Effect::If(
                            Condition::Dead(Target::Friendly(MYSTIC)),
                            vec![Effect::Block(ByAsc(15, 15, 20), Target::_Self)],
                            vec![],
                        ),
            ...
            move_order: vec![Move::Loop(vec![Move::If(
                Condition::HasFriendlies(1),
                vec![Move::Probability(vec![(65, DEFEND, 0), (35, SLASH, 0)])],
                vec![Move::Probability(vec![(65, FURY, 0), (35, SLASH, 0)])],
            )])],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            moveset: vec![
                ...
                MonsterMove {
                    name: ZAP,
                    effects: vec![Effect::AttackDamage(ByAsc(18, 21, 21), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
                MonsterMove {
                    name: DEBILITATE,
                ...
                MonsterMove {
                    name: HEX,
                    effects: vec![Effect::AddBuff(buffs::HEX, Fixed(1), Target::TargetEnemy)],
                    intent: Intent::StrongDebuff,
                },
            ],
            move_order: vec![
                Move::If(Condition::Asc(17), vec![], vec![Move::InOrder(POKE)]),
                Move::InOrder(HEX),
                Move::Loop(vec![
                    Move::Probability(vec![(50, DEBILITATE, 0), (50, DRAIN, 0)]),
                    Move::Probability(vec![(60, POKE, 0), (40, ZAP, 0)]),
                ]),
            ],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            effects: vec![
                (
                    Event::CombatStart,
                    Effect::AddBuff(buffs::BEAT_OF_DEATH, ByAsc(1, 1, 2), Target::_Self),
                ),
                (
                    Event::CombatStart,
                    Effect::AddBuff(buffs::INVINCIBLE, ByAsc(300, 300, 200), Target::_Self),
                ),
            ],
            moveset: vec![
                MonsterMove {
                ...
                MonsterMove {
                    name: ECHO,
                    effects: vec![Effect::AttackDamage(ByAsc(40, 45, 45), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
                MonsterMove {
                    name: BUFF,
            ...
            move_order: vec![
                ...
                Move::Loop(vec![
                    Move::Probability(vec![(50, BLOOD_SHOTS, 1), (50, ECHO, 1)]),
                    Move::Probability(vec![(50, BLOOD_SHOTS, 1), (50, ECHO, 1)]),
                    Move::InOrder(BUFF),
                ]),
            ],
        ...
        BaseMonster {
            ...
            moveset: vec![
                ...
                MonsterMove {
                    name: DARK_STRIKE,
                    effects: vec![Effect::AttackDamage(Fixed(6), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
            ],
            move_order: vec![
                Move::InOrder(INCANTATION),
                Move::Loop(vec![Move::InOrder(DARK_STRIKE)]),
            ],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            move_order: vec![Move::InOrder(STAB), Move::InOrder(EXPLODE)],
            ..BaseMonster::default()
        },
        BaseMonster {
            name: DARKLING,
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::LIFE_LINK, Fixed(1), Target::_Self),
            )],
            n_range: (ByAsc(7, 9, 9), ByAsc(9, 11, 11)),
            moveset: vec![
                MonsterMove {
                    name: NIP,
                    effects: vec![Effect::AttackDamage(N, Target::TargetEnemy)],
                    intent: Intent::Buff,
                },
                MonsterMove {
                    name: CHOMP,
                ...
                MonsterMove {
                    ...
                    effects: vec![
                        ...
                        Effect::If(
                            Condition::Asc(17),
                            vec![Effect::AddBuff(buffs::STRENGTH, Fixed(2), Target::_Self)],
                            vec![],
                        ),
                    ],
                    intent: Intent::Defend,
            ...
            move_order: vec![
                Move::Probability(vec![(50, NIP, 1), (50, HARDEN, 1)]),
                Move::Loop(vec![
                    Move::If(
                        Condition::InPosition(Target::_Self, 1),
                        vec![Move::Loop(vec![Move::Probability(vec![
                            (50, NIP, 2),
                            (50, HARDEN, 1),
                        ])])],
        ...
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::ARTIFACT, ByAsc(2, 2, 3), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
        ...
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::EXPLODE, Fixed(3), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: SLAM,
                    effects: vec![Effect::AttackDamage(Fixed(9), Target::TargetEnemy)],
                    intent: Intent::Buff,
                },
                MonsterMove {
                    name: EXPLODE,
        ...
        BaseMonster {
            ...
            moveset: vec![MonsterMove {
                ...
                effects: vec![
                    ...
                    Effect::If(
                        Condition::Asc(17),
                        vec![Effect::AddBuff(buffs::FRAIL, Fixed(1), Target::TargetEnemy)],
                        vec![],
                    ),
                ],
                intent: Intent::Attack,
            }],
            move_order: vec![Move::Loop(vec![Move::InOrder(SMASH)])],
            ..BaseMonster::default()
        },
        BaseMonster {
            name: FUNGI_BEAST,
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::SPORE_CLOUD, Fixed(2), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: BITE,
        ...
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::SLOW, Fixed(1), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: COUNT,
                    effects: vec![Effect::AttackDamage(Fixed(13), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
                MonsterMove {
                    name: GLARE,
                ...
                MonsterMove {
                    name: IT_IS_TIME,
                    effects: vec![Effect::AttackDamage(Custom, Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
            ],
            move_order: vec![
                Move::Probability(vec![(50, COUNT, 2), (50, GLARE, 2)]),
                Move::Probability(vec![(50, COUNT, 2), (50, GLARE, 2)]),
                Move::Probability(vec![(50, COUNT, 2), (50, GLARE, 2)]),
                Move::If(
                    Condition::Asc(18),
                    vec![],
                    vec![Move::Probability(vec![(50, COUNT, 2), (50, GLARE, 2)])],
                ),
                Move::Loop(vec![Move::InOrder(IT_IS_TIME)]),
            ],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::CURL_UP, N, Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: BITE,
                    effects: vec![Effect::AttackDamage(X, Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
                MonsterMove {
                    name: SPIT_WEB,
        ...
        BaseMonster {
            ...
            move_order: vec![Move::Loop(vec![Move::If(
                Condition::HasFriendlies(0),
                vec![Move::Probability(vec![(75, RALLY, 1), (25, STAB, 1)])],
                vec![Move::If(
                    Condition::HasFriendlies(1),
                    vec![Move::Probability(vec![
                        (25, RALLY, 1),
                        (25, STAB, 1),
                        (15, ENCOURAGE, 1),
                    ])],
                    vec![Move::Probability(vec![(66, ENCOURAGE, 1), (34, STAB, 1)])],
                )],
            )])],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            moveset: vec![
                ...
                MonsterMove {
                    name: RUSH,
                    effects: vec![Effect::AttackDamage(ByAsc(14, 16, 16), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
                MonsterMove {
                    name: SKULL_BASH,
        ...
        BaseMonster {
            ...
            moveset: vec![
                ...
                MonsterMove {
                    name: ULTIMATE_BLAST,
                    effects: vec![Effect::AttackDamage(ByAsc(25, 30, 30), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
            ],
            move_order: vec![Move::Loop(vec![
                ...
                Move::If(
                    Condition::Asc(17),
                    vec![Move::Loop(vec![Move::InOrder(ULTIMATE_BLAST)])],
                    vec![Move::InOrder(ULTIMATE_BLAST)],
                ),
            ])],
            ..BaseMonster::default()
        },
        ...
        BaseMonster {
            ...
            moveset: vec![
                MonsterMove {
                    name: CHOMP,
                    effects: vec![Effect::AttackDamage(ByAsc(11, 12, 12), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
                MonsterMove {
                    name: THRASH,
            ...
            move_order: vec![
                Move::If(Condition::Act(3), vec![], vec![Move::InOrder(CHOMP)]),
                Move::Loop(vec![Move::Probability(vec![
                    (45, BELLOW, 1),
                    (30, THRASH, 2),
                    (25, CHOMP, 1),
        ...
        BaseMonster {
            ...
            effects: vec![
                (
                    Event::CombatStart,
                    Effect::AddBuff(buffs::METALLICIZE, Fixed(8), Target::_Self),
                ),
                (
                    Event::CombatStart,
                    Effect::AddBuff(buffs::ASLEEP, Fixed(1), Target::_Self),
                ),
            ],
            moveset: vec![
                MonsterMove {
            ...
            move_order: vec![
                ...
                Move::If(
                    Condition::Buff(Target::_Self, buffs::ASLEEP),
                    vec![],
                    vec![Move::InOrder(STUNNED)],
                ),
                Move::Loop(vec![
        ...
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::INNATE_THIEVERY, ByAsc(15, 15, 20), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: MUG,
                    effects: vec![Effect::AttackDamage(ByAsc(10, 11, 11), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
                MonsterMove {
                    name: LUNGE,
                ...
                MonsterMove {
                    name: SMOKE_BOMB,
                    effects: vec![Effect::Block(Fixed(6), Target::_Self)],
                    intent: Intent::Defend,
                },
                MonsterMove {
                    name: ESCAPE,
            ...
            move_order: vec![
                Move::InOrder(MUG),
                Move::InOrder(MUG),
                Move::Probability(vec![(50, LUNGE, 1), (50, SMOKE_BOMB, 1)]),
                Move::Probability(vec![(0, ESCAPE, 1), (100, SMOKE_BOMB, 1)]),
                Move::InOrder(ESCAPE),
            ],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::ANGRY, ByAsc(1, 1, 2), Target::_Self),
            )],
            moveset: vec![MonsterMove {
                name: SCRATCH,
                effects: vec![Effect::AttackDamage(ByAsc(4, 5, 5), Target::TargetEnemy)],
                intent: Intent::Attack,
            }],
            move_order: vec![Move::Loop(vec![Move::InOrder(SCRATCH)])],
            ..BaseMonster::default()
        },
        BaseMonster {
            name: MUGGER,
            ...
            moveset: vec![
                ...
                MonsterMove {
                    name: SMOKE_BOMB,
                    effects: vec![Effect::Block(ByAsc(11, 11, 17), Target::_Self)],
                    intent: Intent::Defend,
                },
                MonsterMove {
                    name: ESCAPE,
            ...
            move_order: vec![
                ...
                Move::InOrder(MUG),
                Move::Probability(vec![(50, LUNGE, 1), (50, SMOKE_BOMB, 1)]),
                Move::Probability(vec![(100, SMOKE_BOMB, 1)]),
                Move::InOrder(ESCAPE),
            ],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            move_order: vec![Move::Loop(vec![Move::If(
                Condition::MissingHp(ByAsc(16, 16, 21), Target::AnyFriendly),
                vec![Move::If(
                    Condition::Asc(17),
                    vec![Move::Probability(vec![(100, HEAL, 2)])],
                    vec![Move::Probability(vec![(100, HEAL, 3)])],
                )],
                vec![Move::Probability(vec![
                    (40, BUFF, 2),
                    (60, ATTACK_DEBUFF, 2),
        ...
        BaseMonster {
            ...
            effects: vec![(
                Event::Custom,
                Effect::AddBuff(buffs::INTANGIBLE, Fixed(1), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: DEBUFF,
                ...
                MonsterMove {
                    name: SCYTHE,
                    effects: vec![Effect::AttackDamage(Fixed(45), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
            ],
            move_order: vec![
                Move::Probability(vec![(50, DEBUFF, 1), (50, ATTACK, 1)]),
                Move::Loop(vec![Move::Probability(vec![
                    (35, DEBUFF, 1),
                    (35, ATTACK, 2),
                    (30, SCYTHE, 1),
        ...
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::STRENGTH_UP, ByAsc(3, 3, 5), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: LASER,
                ...
                MonsterMove {
                    name: CLAW,
                    effects: vec![Effect::AttackDamage(ByAsc(15, 16, 16), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
            ],
            move_order: vec![Move::Loop(vec![Move::Probability(vec![
        ...
        BaseMonster {
            ...
            move_order: vec![Move::Loop(vec![Move::InOrder(ATTACK)])],
            ..BaseMonster::default()
        },
        BaseMonster {
            name: RED_LOUSE,
        ...
        BaseMonster {
            ...
            move_order: vec![
                Move::InOrder(STAB),
                Move::Loop(vec![
                    Move::Probability(vec![(25, ENTANGLE, 1), (75, SCRAPE, 2)]),
                    Move::If(
                        Condition::Asc(17),
                        vec![],
                        vec![Move::Probability(vec![(25, ENTANGLE, 1), (75, SCRAPE, 2)])],
                    ),
                    Move::Probability(vec![(25, ENTANGLE, 1), (75, STAB, 2)]),
                ]),
                Move::Event(Event::Buff(buffs::ENTANGLED, Target::AllEnemies)),
                Move::Loop(vec![Move::If(
                    Condition::Asc(17),
                    vec![Move::Probability(vec![(55, SCRAPE, 1), (45, STAB, 2)])],
                    vec![Move::Probability(vec![(55, SCRAPE, 2), (45, STAB, 2)])],
                )]),
            ],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            moveset: vec![
                ...
                MonsterMove {
                    name: BIG_BITE,
                    effects: vec![Effect::AttackDamage(ByAsc(30, 34, 34), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
            ],
            move_order: vec![
                Move::InOrder(SUMMON),
                Move::Loop(vec![Move::If(
                    Condition::HasFriendlies(3),
                    vec![Move::Probability(vec![
                        (67, SNAKE_STRIKE, 1),
                        (33, BIG_BITE, 1),
                    ])],
                    vec![Move::If(
                        Condition::HasFriendlies(4),
                        vec![Move::Probability(vec![
                            (67, SNAKE_STRIKE, 1),
                            (33, BIG_BITE, 1),
                        ])],
        ...
        BaseMonster {
            ...
            moveset: vec![
                MonsterMove {
                    name: BASH,
                    effects: vec![Effect::AttackDamage(Fixed(11), Target::TargetEnemy)],
                    intent: Intent::Unknown,
                },
                MonsterMove {
                    name: REPULSE,
        ...
        BaseMonster {
            ...
            moveset: vec![
                ...
                MonsterMove {
                    name: CROSS_SLASH,
                    effects: vec![Effect::AttackDamage(ByAsc(15, 17, 17), Target::TargetEnemy)],
                    intent: Intent::AttackDebuff,
                },
            ],
            move_order: vec![
                ...
                Move::Loop(vec![
                    ...
                    Move::If(Condition::Asc(17), vec![Move::InOrder(CROSS_SLASH)], vec![]),
                ]),
            ],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            moveset: vec![
                MonsterMove {
                    name: BEAM,
                    effects: vec![Effect::AttackDamage(ByAsc(9, 10, 10), Target::TargetEnemy)],
                    intent: Intent::Unknown,
                },
                MonsterMove {
                    name: BOLT,
            ...
            move_order: vec![
                Move::If(
                    Condition::InPosition(Target::_Self, 1),
                    vec![Move::InOrder(BEAM)],
                    vec![Move::InOrder(BOLT)],
                ),
                Move::Probability(vec![(50, BEAM, 1), (50, BOLT, 1)]),
            ],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::PLATED_ARMOR, Fixed(14), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: DOUBLE_STRIKE,
        ...
        BaseMonster {
            ...
            moveset: vec![
                MonsterMove {
                    name: PROTECT,
                    effects: vec![Effect::Block(ByAsc(7, 8, 11), Target::RandomFriendly)],
                    intent: Intent::Defend,
                },
                MonsterMove {
                    name: SHIELD_BASH,
                    effects: vec![Effect::AttackDamage(ByAsc(6, 8, 8), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
            ],
            move_order: vec![Move::Loop(vec![Move::If(
                Condition::HasFriendlies(0),
                vec![Move::InOrder(SHIELD_BASH)],
                vec![Move::InOrder(PROTECT)],
            )])],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            moveset: vec![
                ...
                MonsterMove {
                    name: SLAM,
                    effects: vec![Effect::AttackDamage(ByAsc(35, 38, 38), Target::TargetEnemy)],
                    intent: Intent::Unknown,
                },
                MonsterMove {
                    name: SPLIT,
                    effects: vec![Effect::Split(ACID_SLIME_L, SPIKE_SLIME_L)],
                    intent: Intent::Unknown,
                },
            ],
            move_order: vec![
        ...
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::MALLEABLE, Fixed(3), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: CHOMP,
            ...
            moveset: vec![
                ...
                MonsterMove {
                    ...
                    effects: vec![
                        ...
                        Effect::If(
                            Condition::Asc(17),
                            vec![Effect::AddBuff(buffs::WEAK, Fixed(2), Target::TargetEnemy)],
                            vec![],
                        ),
                    ],
                    intent: Intent::Attack,
                ...
                MonsterMove {
                    name: BITE,
                    effects: vec![Effect::AttackDamage(ByAsc(15, 18, 18), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
            ],
            move_order: vec![
        ...
        BaseMonster {
            ...
            move_order: vec![Move::Loop(vec![Move::InOrder(PUNCTURE)])],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            effects: vec![
                (
                    Event::CombatStart,
                    Effect::AddBuff(buffs::BARRICADE, Fixed(1), Target::_Self),
                ),
            ...
            moveset: vec![
                ...
                MonsterMove {
                    name: ACTIVATE,
                    effects: vec![Effect::Block(ByAsc(25, 25, 35), Target::_Self)],
                    intent: Intent::Defend,
                },
                MonsterMove {
                    name: HARDEN,
            ...
            move_order: vec![
                ...
                Move::Loop(vec![Move::InOrder(SLAM), Move::InOrder(HARDEN)]),
            ],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            move_order: vec![Move::If(
                ...
                vec![
                    ...
                    Move::Loop(vec![
                        Move::Probability(vec![(50, QUICK_TACKLE, 2), (50, SMASH, 2)]),
                        Move::If(
                            Condition::Buff(Target::AllEnemies, buffs::CONSTRICTED),
                            vec![],
                            vec![Move::InOrder(CONSTRICT)],
                        ),
                    ]),
                ],
                vec![Move::Loop(vec![
                    Move::AfterMove(vec![(
                        CONSTRICT,
                        Move::Probability(vec![(50, QUICK_TACKLE, 1), (50, SMASH, 1)]),
                    )]),
                    Move::If(
                        Condition::Buff(Target::AllEnemies, buffs::CONSTRICTED),
                        vec![Move::Probability(vec![
                        ...
                        vec![Move::Probability(vec![(50, CONSTRICT, 1), (50, SMASH, 1)])],
                    ),
                ])],
            )],
            ..BaseMonster::default()
        ...
        BaseMonster {
            ...
            moveset: vec![
                ...
                MonsterMove {
                    name: SPLIT,
                    effects: vec![Effect::Split(SPIKE_SLIME_M, SPIKE_SLIME_M)],
                    intent: Intent::Unknown,
                },
            ],
            move_order: vec![
        ...
        BaseMonster {
            ...
            moveset: vec![
                ...
                MonsterMove {
                    name: LICK,
                    effects: vec![Effect::AddBuff(buffs::FRAIL, Fixed(1), Target::TargetEnemy)],
                    intent: Intent::Debuff,
                },
            ],
            move_order: vec![Move::Loop(vec![Move::If(
        ...
        BaseMonster {
            ...
            moveset: vec![MonsterMove {
                name: TACKLE,
                effects: vec![Effect::AttackDamage(ByAsc(5, 6, 6), Target::TargetEnemy)],
                intent: Intent::AttackDebuff,
            }],
            move_order: vec![Move::Loop(vec![Move::InOrder(TACKLE)])],
            ..BaseMonster::default()
        },
        BaseMonster {
            name: SPIKER,
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::THORNS, ByAsc(3, 4, 7), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: CUT,
                    effects: vec![Effect::AttackDamage(ByAsc(7, 9, 9), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
                MonsterMove {
                    name: SPIKE,
                    effects: vec![Effect::AddBuff(buffs::THORNS, Fixed(2), Target::_Self)],
                    intent: Intent::Buff,
                },
            ],
            move_order: vec![Move::Loop(vec![Move::If(
                Condition::BuffX(Target::_Self, buffs::THORNS, ByAsc(15, 16, 19)),
                vec![Move::InOrder(CUT)],
                vec![Move::Probability(vec![(50, CUT, 1), (50, SPIKE, 0)])],
            )])],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::ARTIFACT, ByAsc(1, 1, 2), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: BASH,
                ...
                MonsterMove {
                    name: FORTIFY,
                    effects: vec![Effect::Block(Fixed(30), Target::AnyFriendly)],
                    intent: Intent::Buff,
                },
                MonsterMove {
                    name: SMASH,
                    effects: vec![Effect::AttackDamageIfUnblocked(
                        ByAsc(34, 38, 38),
                        Target::TargetEnemy,
                        vec![Effect::If(
                            Condition::Asc(18),
                            vec![Effect::Block(Fixed(99), Target::_Self)],
                            vec![Effect::Block(N, Target::_Self)],
                        )],
                    )],
                    intent: Intent::Buff,
                },
            ...
            move_order: vec![Move::Loop(vec![
                Move::Probability(vec![(50, BASH, 1), (50, FORTIFY, 1)]),
                Move::Probability(vec![(50, BASH, 1), (50, FORTIFY, 1)]),
                Move::InOrder(SMASH),
            ])],
            ..BaseMonster::default()
        ...
        BaseMonster {
            ...
            moveset: vec![
                ...
                MonsterMove {
                    ...
                    effects: vec![
                        ...
                        Effect::If(
                            Condition::Asc(3),
                            vec![Effect::AttackDamage(Fixed(10), Target::TargetEnemy)],
                            vec![],
                        ),
                    ],
                    intent: Intent::Attack,
            ...
            move_order: vec![
                ...
                Move::Loop(vec![
                    Move::InOrder(SKEWER),
                    Move::Probability(vec![(50, BURN_STRIKE, 1), (50, PIERCER, 1)]),
                    Move::Probability(vec![(50, BURN_STRIKE, 1), (50, PIERCER, 1)]),
                ]),
            ],
            ..BaseMonster::default()
        ...
        BaseMonster {
            ...
            move_order: vec![Move::Loop(vec![Move::InOrder(TASKMASTER)])],
            ..BaseMonster::default()
        },
        BaseMonster {
            name: THE_CHAMP,
                    ...
                    Move::If(
                        ...
                        vec![
                            ...
                            Move::Loop(vec![
                                ...
                                Move::If(
                                    Condition::BuffX(Target::_Self, buffs::METALLICIZE, Fixed(10)),
                                    vec![
                        ...
                        vec![Move::If(
                            ...
                            vec![Move::AfterMove(vec![
                                ...
                                (
                                    FACE_SLAP,
                                    Move::Probability(vec![(30, GLOAT, 1), (70, HEAVY_SLASH, 1)]),
                                ),
                                (
                                    HEAVY_SLASH,
                                    Move::Probability(vec![(30, GLOAT, 1), (70, FACE_SLAP, 1)]),
                                ),
                            ])],
                            vec![Move::AfterMove(vec![
                                (
        ...
        BaseMonster {
            ...
            move_order: vec![Move::Loop(vec![
                Move::InOrder(SPAWN),
                Move::Probability(vec![(70, FIREBALL, 1), (30, BUFF, 1)]),
                Move::If(
                    Condition::HasFriendlies(2),
                    vec![Move::Probability(vec![(70, FIREBALL, 0), (30, BUFF, 0)])],
                    vec![Move::Probability(vec![
                        (25, SPAWN, 0),
                        (45, FIREBALL, 2),
                        (30, BUFF, 1),
                ...
                Move::Loop(vec![Move::If(
                    Condition::HasFriendlies(2),
                    vec![Move::Probability(vec![(70, FIREBALL, 2), (30, BUFF, 1)])],
                    vec![Move::Probability(vec![
                        (25, SPAWN, 0),
                        (45, FIREBALL, 2),
                        (30, BUFF, 1),
        ...
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::MODE_SHIFT, ByAsc(30, 35, 40), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: CHARGING_UP,
                    effects: vec![Effect::Block(Fixed(9), Target::_Self)],
                    intent: Intent::Defend,
                },
                MonsterMove {
                    name: FIERCE_BASH,
                    effects: vec![Effect::AttackDamage(ByAsc(32, 36, 36), Target::TargetEnemy)],
                    intent: Intent::Attack,
                },
                MonsterMove {
                    name: VENT_STEAM,
        ...
        BaseMonster {
            ...
            move_order: vec![
                Move::InOrder(ROAR),
                Move::Loop(vec![
                    Move::AfterMove(vec![(NOM, Move::InOrder(DROOL))]),
                    Move::Probability(vec![(33, DROOL, 1), (33, SLAM, 1), (33, NOM, 1)]),
                ]),
            ],
            ..BaseMonster::default()
        },
        BaseMonster {
            ...
            effects: vec![(
                Event::CombatStart,
                Effect::AddBuff(buffs::TIME_WARP, Fixed(12), Target::_Self),
            )],
            moveset: vec![
                MonsterMove {
                    name: REVERBERATE,
                ...
                MonsterMove {
                    ...
                    effects: vec![
                        ...
                        Effect::If(
                            Condition::Asc(19),
                            vec![Effect::Block(Fixed(32), Target::_Self)],
                            vec![],
                        ),
                        Effect::RemoveDebuffs(Target::_Self),
                    ],
        ...
        BaseMonster {
            ...
            moveset: vec![MonsterMove {
                name: TACKLE,
                effects: vec![Effect::AttackDamage(Fixed(7), Target::TargetEnemy)],
                intent: Intent::Attack,
            }],
            move_order: vec![Move::Loop(vec![Move::InOrder(TACKLE)])],
            ..BaseMonster::default()
        ...
        BaseMonster {
            ...
            effects: vec![
                (
                    Event::CombatStart,
                    Effect::AddBuff(buffs::FADING, ByAsc(5, 5, 6), Target::_Self),
                ),
                (
                    Event::CombatStart,
                    Effect::AddBuff(buffs::SHIFTING, Fixed(1), Target::_Self),
                ),
            ],
            moveset: vec![MonsterMove {
                name: ATTACK,
        ...
        BaseMonster {
            ...
            effects: vec![
                ...
                (
                    Event::CombatStart,
                    Effect::AddBuff(buffs::REACTIVE, Fixed(1), Target::_Self),
                ),
            ],
            moveset: vec![
                MonsterMove {
...
pub const BLUE_SLAVER: &str = "SlaverBlue";
...
pub const FAT_GREMLIN: &str = "GremlinFat";
...
pub const MAD_GREMLIN: &str = "GremlinWarrior";
...
pub const RED_SLAVER: &str = "SlaverRed";
...
pub const SHIELD_GREMLIN: &str = "GremlinTsundere";
