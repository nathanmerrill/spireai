...
use crate::{
    models::{
        ...
        cards::BaseCard,
        core::{
            Amount, BattleEffect, CardDestination, CardEffect, CardLocation, CardType, Class,
...
impl BattleState {
    ...
    fn eval_effect(
        ...
        match effect {
            ...
            BattleEffect::Custom => match binding {
